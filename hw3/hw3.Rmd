...
labevents_filtered_itemid_tib %>%
  ...
  print(width = Inf) %>%
  dbWriteTable(con, "mimic_labevents_icu", ., overwite = TRUE, row.names = FALSE)
```
...
chartevents_filtered_itemid_tib %>%
  ...
  print(width = Inf) %>%
  dbWriteTable(con, "mimic_chartevents_icu", ., overwite = TRUE, row.names = FALSE)
```
