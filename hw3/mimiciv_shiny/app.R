...
ui <- fluidPage(
    ...
    # sidebarPanel(selectInput('nuvpl', 'Choose Summary type:',
    #                          choices = c('Numeric',
    #                                      'Histogram'))),
...
server <- function(input, output){
    output$sum = renderPrint({
        datasetInput <- switch(input$variable,
                               ...
                               'Discharge Location' = icu_cohort$discharge_location,
                               ...
                               'Hospital Expired Flag' = icu_cohort$hospital_expire_flag,
                               'Gender' = icu_cohort$gender,
                               'Anchor Age' = icu_cohort$anchor_age,
                               'Anchor Year' = icu_cohort$anchor_year,
                               'Anchor Year Group' = icu_cohort$anchor_year_group,
                               'DOD' = icu_cohort$dod,
...
'Non-invasive Blood Pressure Systolic' = icu_cohort$non_invasive_blood_pressure_systolic,
'Non-invasive Blood Pressure Mean' = icu_cohort$non_invasive_blood_pressure_mean,
                               'Respiratory Rate' = icu_cohort$respiratory_rate,
                               'Temperature Fahrenheit' = icu_cohort$temperature_fahrenheit,
...
'Arterial Blood Pressure Mean' = icu_cohort$arterial_blood_pressure_mean,
    ...
    output$hist = renderPlot({
        ...
        if (is.numeric(datasetInput)){
            hist(datasetInput, breaks = input$binnum, main=input$variable,xlab =input$variable )
        }
